...
#귀무가설 : 교육수준이 흡연율에 관련이 없다.
#대립가설 : 교육수준이 흡연율에 관련이 있다.
...
#<단계 5> 검정결과 해석
# p_value 가 0.0008182573 < 0.05 이므로 귀무가설 기각 대립가설 채택
# 교육수준이 흡연율에 관련이 있을수있다.
...
# p-vaule  6.901e-12 < 0.05 이므로 귀무가설 기각 직업에따른 응답차이 있다고 볼수있다.
